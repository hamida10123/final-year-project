...
<head>
  ...
  <link rel="stylesheet" href="../css/cultural areas.css">
  <link rel="stylesheet" href="../css/warm areas.css">
...
<body>
  ...
  <div class="loop">
    ...
    <div class="hope">
      <h1 class="Our"> Cultural Areas Tours</h1>
      <p><span style="color: blue; margin-right: 10px;">Home</span><span style="color: black; font-weight: bold;
 ">/</span><span style="color: blue; margin-right: 10px; margin-left:10px ;">Pages</span><span style="color: black; font-weight: bold;">/</span> <span style="margin-left: 10px;">Cultural Areas Tours</span></p>
    ...
    <section class="packages">
      ...
      <div class="package-card" style="margin-left: 150px;">
          <img src="https://i.ibb.co/2YLctWcm/Kalash-Valley.jpg" alt="Altit Fort">
          <h2>Kalash Valley </h2>
         
          <a href="Kalash Valley AR.php">
            <button class="book-now" >View AR</button></a>
      </div>
  
      
  
      <div class="package-card" style="margin-left: 70px;">
          <img src="https://i.ibb.co/9k3vWgzX/muzafarabad-neelum-jehlum.jpg" alt="Hunza Museum">
          <h2>Muzaffarabad </h2>
 
          <a href="Muzzafarabad AR .php">
            <button class="book-now"x>View AR</button></a>
      </div>
  
      <div class="package-card">
          <img src="https://i.ibb.co/1JJkxRm9/swat.jpg" alt="Shandur Polo Festival">
          <h2>Swat</h2>
