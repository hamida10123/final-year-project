...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Naltar Summer.jpg')">Summer</button>
        <button onclick="showImage('Naltar Winter.jpg')">Winter</button>
        <button onclick="showImage('Naltar Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Naltar Sprin.jpg')">Spring</button>
    </div>
