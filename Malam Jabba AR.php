...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Malam Jabba Summer.jpg')">Summer</button>
        <button onclick="showImage('Malam Jabba Winter.jpg')">Winter</button>
        <button onclick="showImage('Malam Jabba Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Malam Jabba Spring.jpg')">Spring</button>
    </div>
