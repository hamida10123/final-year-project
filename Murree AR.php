...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Murree Summer.jpg')">Summer</button>
        <button onclick="showImage('Murree winter.jpg')">Winter</button>
        <button onclick="showImage('Murree autmn.jpg')">Autumn</button>
        <button onclick="showImage('murree spring.jpg')">Spring</button>
    </div>
