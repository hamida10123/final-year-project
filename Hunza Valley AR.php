...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Hunza Valley Summer.jpg')">Summer</button>
        <button onclick="showImage('Hunza Valley winter.jpg')">Winter</button>
        <button onclick="showImage('Hunza Valley Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Hunza Valley Spring.jpg')">Spring</button>
    </div>
