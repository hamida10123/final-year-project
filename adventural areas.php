...
$sql = "SELECT t.tour_id, t.tour_name, t.main_image, t.price, t.discount, 
        ...
        WHERE t.category = 'adventure'  -- Only select cold area tours
        GROUP BY t.tour_id";
...
<head>
  ...
  <style>
    ...
    // Add inside existing <style> tags in adventural areas.php
...
<body>
  ...
  <a href="booking.php" class="bookingon">Book Now</a>
      ...
      <div class="hope">
      <h1 class="Our">Adventural Areas Tours</h1>
      <p><span style="color: blue; margin-right: 10px;">Home</span><span style="color: black; font-weight: bold;
 ">/</span><span style="color: blue; margin-right: 10px; margin-left:10px ;">Pages</span><span style="color: black; font-weight: bold;">/</span> <span style="margin-left: 10px;">Adventural Areas Tours</span></p>
  ...
  <div class="tour-packages">
    ...
    ?>
            <div class="tour-card">
               ...
               <a href="#" onclick="handleBookNow(<?php echo $tour['tour_id']; ?>)" class="tour-btn">Book Now</a>
                  <script>
