...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Kalash Valley Summer.jpg')">Summer</button>
        <button onclick="showImage('Kalash Valley Winter.jpg')">Winter</button>
        <button onclick="showImage('Kalash Valley Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Kalash Valley Spring.jpg')">Spring</button>
    </div>
