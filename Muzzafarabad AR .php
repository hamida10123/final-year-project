...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Muzzafarabad Summer.jpg')">Summer</button>
        <button onclick="showImage('Muzzafarabad Winter.jpg')">Winter</button>
        <button onclick="showImage('Muzzafarabad Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Muzzafarabad Spring.jpg')">Spring</button>
    </div>
