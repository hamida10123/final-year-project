...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Rawalakot Summer.jpg')">Summer</button>
        <button onclick="showImage('Rawalakot Winter.jpg')">Winter</button>
        <button onclick="showImage('Rawalakot Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Rawalakot Spring.jpg')">Spring</button>
    </div>
