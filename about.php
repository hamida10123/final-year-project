...
<div class="why-choose">
  <h2>Why Choose HRI TOURS?</h2>
  <div class="features">
    <div class="feature-box">
      <i class="fas fa-map-marked-alt"></i>
      <h4>Expert Tour Planning</h4>
      <p>We customize travel plans to your style and budget for a unique experience.</p>
    </div>
    <div class="feature-box">
      <i class="fas fa-hotel"></i>
      <h4>Luxury Accommodations</h4>
      <p>Stay in handpicked hotels offering comfort, elegance, and top service.</p>
    </div>
    <div class="feature-box">
      <i class="fas fa-headset"></i>
      <h4>24/7 Support</h4>
      <p>We’re always just a call away, ready to help anytime, anywhere.</p>
    </div>
    <div class="feature-box">
      <i class="fas fa-star"></i>
      <h4>Trusted by Travelers</h4>
      <p>Hundreds of happy travelers trust our tours and love our service.</p>
    </div>
  </div>
</div>
