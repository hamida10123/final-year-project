...
<head>
  ...
  <link rel="stylesheet" href="../css/adventure areas.css">
...
<body>
  ...
  <div class="loop">
    ...
    <div class="hope">
      <h1 class="Our"> Adventure Areas Tours</h1>
      <p><span style="color: blue; margin-right: 10px;">Home</span><span style="color: black; font-weight: bold;
 ">/</span><span style="color: blue; margin-right: 10px; margin-left:10px ;">Pages</span><span style="color: black; font-weight: bold;">/</span> <span style="margin-left: 10px;"> Adventure Areas Tours</span></p>
      
    </div>
    </div>
    <section class="packages">
      <div class="package-card">
          <img src="https://i.ibb.co/xtv9s0KB/trekking-k2-base-camp.jpg" alt="K2 Base Camp">
          <h2>K2 Base Camp</h2>
    
          <a href="K2 AR.php">
          <button class="book-now">View AR</button></a>
      </div>
  
      <div class="package-card">
          <img src="https://i.ibb.co/nNn7PFfF/Deosai-National-Park-0.jpg" alt="Mount Rakaposhi">
          <h2>Deosai National Park </h2>
      
          <a href="Deosai National Park AR.php">
          <button class="book-now">View AR</button></a>
      </div>
  
      <div class="package-card">
          <img src="https://i.ibb.co/0VWzYv6d/naran-kaghan-v.jpg" alt="Indus River">
          <h2>Naran Kaghan Valley</h2>
        
          <a href="Naran Kagan AR.php">
          <button class="book-now">View AR</button></a>
      </div>
  
      <div class="package-card" style="margin-bottom: 100px;">
          <img src="https://i.ibb.co/DPQkfPbT/Terich-Mir.jpg" alt="Horse Riding">
          <h2>Tirich Mir</h2>
       
          <a href="Tirich Mir AR.php">
          <button class="book-now">View AR</button></a>
      </div>
  
      <div class="package-card" style="margin-bottom: 100px;">
          <img src="https://i.ibb.co/PGcTpwrz/fairyy.jpg" alt="Naltar Ski Resort">
          <h2>Fairy Meadows</h2>
          
          <a href="Fairy meadow AR.php">
          <button class="book-now">View AR</button></a>
      </div>
  </section>
