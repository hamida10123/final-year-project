...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Naran Summer.jpg')">Summer</button>
        <button onclick="showImage('Naran Winter.jpg')">Winter</button>
        <button onclick="showImage('Naran Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Naran Spring.jpg')">Spring</button>
    </div>
