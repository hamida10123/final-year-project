...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Skardu Summer.jpg')">Summer</button>
        <button onclick="showImage('Skardu Winter.jpg')">Winter</button>
        <button onclick="showImage('Skardu Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Skardu Spring.jpg')">Spring</button>
    </div>
