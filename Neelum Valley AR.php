...
<body>
    ...
    <h2>Select a Season to View</h2>
     ...
     <div class="buttons">
        <button onclick="showImage('Neelum Valley Summer.jpg')">Summer</button>
        <button onclick="showImage('Neelum Valley Winter.jpg')">Winter</button>
        <button onclick="showImage('Neelum Valley Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Neelum Valley SPring.jpg')">Spring</button>
    </div>
