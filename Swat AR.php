...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Swat Summer.jpg')">Summer</button>
        <button onclick="showImage('Swat Winter.jpg')">Winter</button>
        <button onclick="showImage('Swat Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Swat Spring.jpg')">Spring</button>
    </div>
