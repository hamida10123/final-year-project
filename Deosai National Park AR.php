...
<body>
    ...
    <div class="buttons">
        <button onclick="showImage('Deosai National Park Summer.jpg')">Summer</button>
        <button onclick="showImage('Deosai National Park Winter.jpg')">Winter</button>
        <button onclick="showImage('Deosai-National Park Autumn.jpg')">Autumn</button>
        <button onclick="showImage('Deosai National Park Spring.jpg')">Spring</button>
    </div>
