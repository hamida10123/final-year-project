...
$sql = "SELECT t.tour_id, t.tour_name, t.main_image, t.price, t.discount, 
        ...
        WHERE t.category = 'warm'  -- Only select cold area tours
        GROUP BY t.tour_id";
...
<body>
  ...
  <div class="loop">
    ...
    <div class="navbar-2">
      ...
      <div class="hope">
      <h1 class="Our">Warm Areas Tours</h1>
      <p><span style="color: blue; margin-right: 10px;">Home</span><span style="color: black; font-weight: bold;
 ">/</span><span style="color: blue; margin-right: 10px; margin-left:10px ;">Pages</span><span style="color: black; font-weight: bold;">/</span> <span style="margin-left: 10px;">Warm Areas Tours</span></p>
