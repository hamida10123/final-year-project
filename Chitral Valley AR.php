...
<body>
 ...
 <div class="buttons">
        <button onclick="showImage('K2 Summer.jpg')">Summer</button>
        <button onclick="showImage('K2 Winter.jpg')">Winter</button>
        <button onclick="showImage('K2 Autumn.jpg')">Autumn</button>
        <button onclick="showImage('K2 Spring.jpg')">Spring</button>
    </div>
